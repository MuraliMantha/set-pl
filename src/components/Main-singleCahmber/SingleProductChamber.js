  ...
  <div class="carousel-inner">
    ...
    <div className="product-gallery">
        <div className="product-card unique-product-card-1">
          <img src="./assets/research.jpg" alt="Product 1" className="product-image" />
    ...
    <div className="product-gallery">
        <div className="product-card unique-product-card-1">
          <img src="./assets/research1.jpg" alt="Product 1" className="product-image" />
          <div className="product-info">
            <h2 className="product-title">Product 1</h2>
          </div>
        </div>
    ...
    <div className="product-gallery">
        <div className="product-card unique-product-card-1">
          <img src="./assets/research2.jpg" alt="Product 1" className="product-image" />
          <div className="product-info">
            <h2 className="product-title">Product 1</h2>
          </div>
        </div>
